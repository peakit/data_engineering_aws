...
#
airflow connections add myawsuser --conn-uri 'aws://AKIA4UCOFYTXTTLAQWUF:oESCuHgwScjhC58Z2Cq7QnqTkTAfnT2zjgY8fhsM@'
#
#
# TO-DO: run the follwing command and observe the JSON output: 
...
# TO-DO: Update the following command with the URI and un-comment it:
#
airflow connections add myredshiftuser --conn-uri 'redshift://awsuser:AWSUser%231@default.867747349743.us-east-1.redshift-serverless.amazonaws.com:5439/dev'
#
# TO-DO: update the following bucket name to match the name of your S3 bucket and un-comment it:
#
airflow variables set s3_bucket 20230130-data-pipeline
#
# TO-DO: un-comment the below line:
#
airflow variables set s3_prefix ""